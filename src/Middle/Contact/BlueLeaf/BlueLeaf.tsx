import classes from './BlueLeaf.module.scss'

export default function BlueLeaf() {
  return (
    <div className={classes.blueLeaf}>
      <svg width="100%" height="100%" viewBox="0 0 40 22" fill="none" xmlns="http://www.w3.org/2000/svg">
