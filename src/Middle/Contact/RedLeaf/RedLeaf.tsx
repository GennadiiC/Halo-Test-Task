import classes from './RedLeaf.module.scss'

export default function RedLeaf() {
  return (
    <div className={classes.redLeaf}>
      <svg width="100%" height="100%" viewBox="0 0 61 56" fill="none" xmlns="http://www.w3.org/2000/svg">
