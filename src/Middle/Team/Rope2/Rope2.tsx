import classes from './Rope2.module.scss'

export default function Rope2 () {
  return (
    <div className={classes.rope2}>
      <svg width="100%" height="100%" viewBox="0 0 394 180" fill="none" xmlns="http://www.w3.org/2000/svg">
